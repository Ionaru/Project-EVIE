        ...
        <div class="col-sm-2 col-md-1">
            <div class="sidebar">
                <ul class="nav nav-sidebar">
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $dashboardactive; ?>"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $skillsactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $contactsactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $mailactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $marketactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $walletactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $assetsactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $planetsactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $industryactive; ?>"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                    ...
                    <li><a class="<?php echo $disabled; ?>sidebar_button<?php echo $calendaractive; ?> EVETime"
                           data-toggle="tooltip" data-html="true"
                           data-placement="right"
                           data-container="body"
                           title='<div class="text-left"><strong>Calendar</strong><br>Yep, you are late!</div>'
                           href=<?php echo '"calendar.php"'; ?>><span id="EVETime_Hours">00</span>:<span
                                id="EVETime_Minutes">00</span></a></li>
                </ul>
            </div>
        </div>
