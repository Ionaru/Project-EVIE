...
<div class="col-md-6" id="registersection">
    ...
    <?php echo '<form method="post" action="'.$_SERVER['SCRIPT_NAME'].'?char=0&action=register" name="registerform">';?>
      <div class="form-group">
        ...
        <input id="uname" class="form-control" type="text" pattern="[a-zA-Z0-9]{2,50}" name="user_name" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input id="pwd" class="form-control" type="password" name="user_password_new" pattern=".{6,}" autocomplete="off" required>
      </div>
      <div class="form-group">
        <label for="user_password_repeat">Confirm Password</label>
        <input id="pwd2" class="form-control" type="password" name="user_password_repeat" pattern=".{6,}" required autocomplete="off">
      </div>
...
<div class="col-md-6" id="loginsection">
  ...
  <form method="post" action=<?php echo $_SERVER['SCRIPT_NAME'];?> name="loginform">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="login_input_password" name="user_password" required/>
    </div>
...
<button data-toggle="modal" data-target="#registerModal" type="button" class="btn btn-lg btn-success btn-block">Register</button><br>
<button data-toggle="modal" data-target="#loginModal" type="button" class="btn btn-lg btn-primary btn-block">Log in</button><br>
<button data-toggle="modal" data-target="#tempModal" type="button" class="btn btn-lg btn-info btn-block">Use Temporary Key</button>
...
<div id="lostpassModal" class="modal fade">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <form method="post" action="<?php echo $_SERVER['SCRIPT_NAME'].'?action=recover';?>" name="lostpassform">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="registerModal" class="modal fade">
  <div class="modal-dialog modal-md">
    <div class="modal-content"> <?php echo '<form method="post" action="' . $_SERVER['SCRIPT_NAME'] . '?action=register" name="registerform">';?>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
        ...
        <input id="uname" class="form-control" type="text" pattern="[a-zA-Z0-9]{2,16}" name="user_name" required/>
        <br>
        <div class="row">
          <div class="col-sm-6">
            <label class="control-label" for="pwd">Password:</label>
            <input id="pwd" class="form-control" type="password" name="user_password_new" pattern=".{6,}" required autocomplete="off"/>
          </div>
          <br>
          <div class="col-sm-6">
...
<div id="passwordModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    <div class="modal-content"><form method="post" action="<?php echo $_SERVER['SCRIPT_NAME'].'?action=change';?>" name="passwordform">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
        ...
        <input id="user_password_old" class="form-control" type="password" name="user_password_old" pattern=".{6,}" required autocomplete="off"/>
        <br>
        <div class="row">
          <div class="col-sm-6">
